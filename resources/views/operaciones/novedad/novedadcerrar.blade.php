				...
				<div class="widget-body fuelux">
					<div class="wizard" data-initialize="wizard" id="myWizard">
						...
						<div class="step-content">
							<form action="" class="form-horizontal" id="novedadform">
												...
												<div class="panel panel-default">
													...
													<div class="panel-body">
														<div class="col-md-6">
															...
															<div class="form-group">
																<label class="col-md-4  control-label">TIPO DE
																	OCURRENCIA</label>
																<div class="col-md-8 col-xs-12">
																	<select id="ocurrencia" name="ocurrencia"
																	        class="form-control select">
																		@foreach($ocurrencias as $ocurrencia)
																			<option value="{{$ocurrencia->IdBono}}">{{$ocurrencia->Descripcion}}</option>
																		@endforeach
																	</select>
																</div>
															</div>
														...
														<div class="col-md-6">
															...
															<div class="form-group">
																<label class="col-md-4 control-label">DESCUENTO DE
																	BONO</label>
																<div class="col-md-8 col-xs-12">
																	<p id="descbono" class="form-control"
																	   style="background-color: #EEEEEE">20</p>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-md-8 col-xs-12">
																	<select id="tecnico" name="tecnico"
																		...
																		@foreach($inspectores as $inspector)
																			<option value="{{$inspector->IdEmpleado}}">
...
// IMPORTANT: You must call .steps() before calling .formValidation()
        ...
        $("#ocurrencia").change(function () {
            $.post("/operaciones/descbono", {var1: $(this).val()})
                .done(function (data) {
                    $("#descbono").html(data);
                });
        });
        ...
        // Call the wizard plugin
            ...
            .on('finished.fu.wizard', function (e) {
                ...
                if (isValidStep === true) {
                    ...
                    var cadena = $("#novedadform").serialize();
                    console.log(cadena);
                    $.post("/operaciones/novcierre/registrar", cadena)
                        .done(function (data) {
